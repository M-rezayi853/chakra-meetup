...
const FooterBottom = () => {
  return (
    <Box mt={'5'} color='#fff' background={'#212121'} py='10'>
      <Container maxW={'container.xl'}>
        <Box d='flex' alignItems={'center'}>
          <Heading size={'md'}>گروه Meetup خود را ایجاد کنید.</Heading>
          <Button mr={'4'} colorScheme='white' variant={'outline'}>
            شروع کنید
          </Button>
        </Box>
        ...
        >
          ...
          >
            <Heading size={'sm'}>حساب شما</Heading>
            <List mt={'4'} spacing='2'>
              <ListItem>
                <Link color={'#a2a2a2'}>ثبت نام</Link>
              </ListItem>
              <ListItem>
                <Link color={'#a2a2a2'}>وارد شدن</Link>
              </ListItem>
              <ListItem>
                <Link color={'#a2a2a2'}>کمک</Link>
              </ListItem>
            </List>
          </Box>
          ...
          >
            <Heading size={'sm'}>كشف كردن</Heading>
            <List mt={'4'} spacing='2'>
              <ListItem>
                <Link color={'#a2a2a2'}>گروه ها</Link>
              </ListItem>
              <ListItem>
                <Link color={'#a2a2a2'}>تقویم</Link>
              </ListItem>
              <ListItem>
                <Link color={'#a2a2a2'}>موضوعات</Link>
              </ListItem>
              <ListItem>
                <Link color={'#a2a2a2'}>شهرها</Link>
              </ListItem>
              <ListItem>
                <Link color={'#a2a2a2'}>رویدادهای آنلاین</Link>
              </ListItem>
              <ListItem>
                <Link color={'#a2a2a2'}>راهنماهای محلی</Link>
              </ListItem>
            </List>
          </Box>
          ...
          >
            <Heading size={'sm'}>ملاقات</Heading>
            <List mt={'4'} spacing='2'>
              <ListItem>
                <Link color={'#a2a2a2'}>در باره ما</Link>
              </ListItem>
              <ListItem>
                <Link color={'#a2a2a2'}>وبلاگ</Link>
              </ListItem>
              <ListItem>
                <Link color={'#a2a2a2'}>مشاغل</Link>
              </ListItem>
              <ListItem>
                <Link color={'#a2a2a2'}>برنامه ها</Link>
              </ListItem>
            </List>
          </Box>
        </Box>
        ...
        >
          ...
          >
            <Image w={'120px'} h='38px' mr={'6'} src={androidBtn} alt='btn' />
            <Image w={'120px'} h='38px' mr={'6'} src={iosBtn} alt='btn' />
          </Box>
        </Box>
